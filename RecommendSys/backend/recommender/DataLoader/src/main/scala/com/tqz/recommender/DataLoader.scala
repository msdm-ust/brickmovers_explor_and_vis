...
object DataLoader {
  // 定义数据文件路径
  val PRODUCT_DATA_PATH = "/root/ECommerceRecommendSystem/backend/recommender/DataLoader/src/main/resources/products.csv"
//  val PRODUCT_DATA_PATH = "D:\\VS Code Project\\recommendsystem\\backend\\recommender\\DataLoader\\src\\main\\resources\\products.csv"
  val RATING_DATA_PATH = "/root/ECommerceRecommendSystem/backend/recommender/DataLoader/src/main/resources/ratings.csv"
